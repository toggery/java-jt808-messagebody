 ...
 * @author togger
 */
public final class Message<B extends Codec> extends AbstractToStringJoiner {
     ...
     * @param <T> 消息体类型
     * @throws NullPointerException 如果参数对象 {@code msg/bufSupplier/bufConsumer/attributeMap} 中的任何一个为 {@code null}
     * @throws EncodingException 如果执行过程中出现编码错误
     */
    public static <T extends Codec> void encode(Message<T> msg, Function<Integer, ByteBuf> bufSupplier,
     ...
     */
    public static <T extends Codec> Message<T> decode(ByteBuf buf,
     ...
     * @throws DecodingException 如果执行过程中出现解码错误
     */
    public static <T extends Codec> Message<T> decodeWithoutDelimiters(ByteBuf buf,
                                                                       Map<Integer, MessageMetadata> messageMetadataMap,
                                                                       AttributeMap attributeMap) {
        Objects.requireNonNull(buf);
        Objects.requireNonNull(attributeMap);
     ...
     * @return 消息实例
     */
    public static <T extends Codec> Message<T> of(int id, T body) {
        final Message<T> msg = new Message<>();
        msg.setId(id);
        msg.body = body;
        return msg;
     ...
     * @return 应答消息
     */
    public static <T extends Codec> Message<T> replyAs(int id, T body, Message<?> request) {
    ...
    protected void toStringJoiner(StringJoiner joiner) {
        joiner
                ...
                .add(IntUtil.wordHexString("bodyProps=", bodyProps))
    ...
    private static <T extends Codec> Message<T> castBodyPackets(Message<?> packets) {
