 ...
 * @author togger
 */
public class B8401 extends AbstractToStringJoiner implements Codec {
    ...
    public void encode(int version, ByteBuf buf) {
        ...
        Codec.writeCountHeadedContent(buf, IntUnit.BYTE, contacts, (b, that) -> {
            int count = 0;
            for (final Contact contact : that) {
                if (contact == null) continue;
                contact.encode(version, b);
                count++;
            }
            return count;
        });
     ...
     * @author togger
     */
    public static class Contact extends AbstractToStringJoiner implements Codec {
        ...
        public void encode(int version, ByteBuf buf) {
            Codec.writeByte(buf, type);
            Codec.writeString(buf, IntUnit.BYTE, phone);
        ...
        public void decode(int version, ByteBuf buf) {
            type = Codec.readByte(buf);
            phone = Codec.readString(buf, IntUnit.BYTE);
