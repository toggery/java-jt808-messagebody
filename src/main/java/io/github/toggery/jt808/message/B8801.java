 ...
 * @author togger
 */
public class B8801 extends AbstractToStringJoiner implements Codec {
    ...
    public void encode(int version, ByteBuf buf) {
        ...
        Codec.writeWord(buf, command);
        Codec.writeWord(buf, interval);
        Codec.writeByte(buf, action);
        Codec.writeByte(buf, resolution);
        Codec.writeByte(buf, quality);
        Codec.writeByte(buf, brightness);
        Codec.writeByte(buf, contrast);
        Codec.writeByte(buf, saturation);
        Codec.writeByte(buf, chroma);
    }

    @Override
    public void decode(int version, ByteBuf buf) {
        channel = Codec.readByte(buf);
        command = Codec.readWord(buf);
        interval = Codec.readWord(buf);
        action = Codec.readByte(buf);
        resolution = Codec.readByte(buf);
        quality = Codec.readByte(buf);
        brightness = Codec.readByte(buf);
        contrast = Codec.readByte(buf);
        saturation = Codec.readByte(buf);
        chroma = Codec.readByte(buf);
    }
