 ...
 * @author togger
 */
public class B8103 extends AbstractToStringJoiner implements Codec {
    ...
    protected void toStringJoiner(StringJoiner joiner) {
        joiner
                ...
                .add("x0032=" + (x0032 == null ? "" : ByteBufUtil.hexDump(x0032)))
    ...
    private final static class Params {
        ...
        static {
            ...
            // 0x0001 DWORD 终端心跳发送间隔，单位为秒（s）
            register(0x0001, B8103::getX0001, B8103::setX0001, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0002 DWORD TCP 消息应答超时时间，单位为秒（s）
            register(0x0002, B8103::getX0002, B8103::setX0002, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0003 DWORD TCP 消息重传次数
            register(0x0003, B8103::getX0003, B8103::setX0003, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0004 DWORD UDP 消息应答超时时间，单位为秒（s）
            register(0x0004, B8103::getX0004, B8103::setX0004, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0005 DWORD UDP 消息重传次数
            register(0x0005, B8103::getX0005, B8103::setX0005, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0006 DWORD SMS 消息应答超时时间，单位为秒（s）
            register(0x0006, B8103::getX0006, B8103::setX0006, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0007 DWORD SMS 消息重传次数
            register(0x0007, B8103::getX0007, B8103::setX0007, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);

            // 0x0010 STRING 主服务器 APN，无线通信拨号访问点，若网络制式为 CDMA，则该处为 PPP 拨号号码
            register(0x0010, B8103::getX0010, B8103::setX0010, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0011 STRING 主服务器无线通信拨号用户名
            register(0x0011, B8103::getX0011, B8103::setX0011, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0012 STRING 主服务器无线通信拨号密码
            register(0x0012, B8103::getX0012, B8103::setX0012, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0013 STRING 主服务器地址、IP 或域名(2019 版以冒号分割主机和端口，多个服务器使用分号分隔)
            register(0x0013, B8103::getX0013, B8103::setX0013, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0014 STRING 备份服务器 APN，无线通信拨号访问点
            register(0x0014, B8103::getX0014, B8103::setX0014, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0015 STRING 备份服务器无线通信拨号用户名
            register(0x0015, B8103::getX0015, B8103::setX0015, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0016 STRING 备份服务器无线通信拨号密码
            register(0x0016, B8103::getX0016, B8103::setX0016, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0017 STRING 备份服务器地址，IP 或域名(2019 版以冒号分割主机和端口，多个服务器使用分号分隔)
            register(0x0017, B8103::getX0017, B8103::setX0017, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0018 DWORD 服务器 TCP 端口 // 2019 del
            register(0x0018, B8103::getX0018, B8103::setX0018,
                    ver -> ver < 1 ? Codec::writeDoubleWord : null,
                    ver -> ver < 1 ? Codec::readDoubleWord : null
            );
            // 0x0019 DWORD 服务器 UDP 端口 // 2019 del
            register(0x0019, B8103::getX0019, B8103::setX0019,
                    ver -> ver < 1 ? Codec::writeDoubleWord : null,
                    ver -> ver < 1 ? Codec::readDoubleWord : null
            );
            // 0x001A STRING 道路运输证 IC 卡认证主服务器 IP 地址或域名
            register(0x001A, B8103::getX001A, B8103::setX001A, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x001B DWORD 道路运输证 IC 卡认证主服务器 TCP 端口
            register(0x001B, B8103::getX001B, B8103::setX001B, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x001C DWORD 道路运输证 IC 卡认证主服务器 UDP 端口
            register(0x001C, B8103::getX001C, B8103::setX001C, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x001D STRING 道路运输证 IC 卡认证备份服务器 IP 地址或域名，端口同主服务器
            register(0x001D, B8103::getX001D, B8103::setX001D, ver -> Codec::writeString, ver -> Codec::readString);

            // 0x0020 DWORD 位置汇报策略，0：定时汇报；1：定距汇报；2：定时和定距汇报
            register(0x0020, B8103::getX0020, B8103::setX0020, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0021 DWORD 位置汇报方案，0：根据 ACC 状态；1：根据登录状态和 ACC 状态，先判断登录状态，若登录再根据 ACC 状态
            register(0x0021, B8103::getX0021, B8103::setX0021, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0022 DWORD 驾驶员未登录汇报时间间隔，单位为秒（s），值大于 0
            register(0x0022, B8103::getX0022, B8103::setX0022, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);

            // 0x0023 STRING 从服务器 APN，该值为空时，终端应使用主服务器相同配置 // 2019 new
            register(0x0023, B8103::getX0023, B8103::setX0023,
                    ver -> ver > 0 ? Codec::writeString : null,
                    ver -> ver > 0 ? Codec::readString : null
            );
            // 0x0024 STRING 从服务器无线通信拨号用户名，该值为空时，终端应使用主服务器相同配置 // 2019 new
            register(0x0024, B8103::getX0024, B8103::setX0024,
                    ver -> ver > 0 ? Codec::writeString : null,
                    ver -> ver > 0 ? Codec::readString : null
            );
            // 0x0025 STRING 从服务器无线通信拨号密码，该值为空时，终端应使用主服务器相同配置 // 2019 new
            register(0x0025, B8103::getX0025, B8103::setX0025,
                    ver -> ver > 0 ? Codec::writeString : null,
                    ver -> ver > 0 ? Codec::readString : null
            );
            // 0x0026 STRING 从服务器备份地址、IP 地址或域名，主机和端口用冒号分割，多个服务器使用分号分割 // 2019 new
            register(0x0026, B8103::getX0026, B8103::setX0026,
                    ver -> ver > 0 ? Codec::writeString : null,
                    ver -> ver > 0 ? Codec::readString : null
            );

            // 0x0027 DWORD 休眠时汇报时间间隔，单位为秒（s），值大于 0
            register(0x0027, B8103::getX0027, B8103::setX0027, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0028 DWORD 紧急报警时汇报时间间隔，单位为秒（s），值大于 0
            register(0x0028, B8103::getX0028, B8103::setX0028, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0029 DWORD 缺省时间汇报间隔，单位为秒（s），值大于 0
            register(0x0029, B8103::getX0029, B8103::setX0029, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);

            // 0x002C DWORD 缺省距离汇报间隔，单位为米（m），值大于 0
            register(0x002C, B8103::getX002C, B8103::setX002C, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x002D DWORD 驾驶员未登录汇报距离间隔，单位为米（m），值大于 0
            register(0x002D, B8103::getX002D, B8103::setX002D, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x002E DWORD 休眠时汇报距离间隔，单位为米（m），值大于 0
            register(0x002E, B8103::getX002E, B8103::setX002E, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x002F DWORD 紧急报警时汇报距离间隔，单位为米（m），值大于 0
            register(0x002F, B8103::getX002F, B8103::setX002F, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0030 DWORD 拐点补传角度，值小于 180
            register(0x0030, B8103::getX0030, B8103::setX0030, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0031 WORD 电子围栏半径（非法位移阈值），单位为米（m）
            register(0x0031, B8103::getX0031, B8103::setX0031, ver -> Codec::writeWord, ver -> Codec::readWord);
            ...
            // 0x0040 STRING 监控平台电话号码
            register(0x0040, B8103::getX0040, B8103::setX0040, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0041 STRING 复位电话号码，可采用此电话号码拨打终端电话让终端复位
            register(0x0041, B8103::getX0041, B8103::setX0041, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0042 STRING 恢复出厂设置电话号码，可采用此电话号码拨打终端电话让终端恢复出厂设置
            register(0x0042, B8103::getX0042, B8103::setX0042, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0043 STRING 监控平台 SMS 电话号码
            register(0x0043, B8103::getX0043, B8103::setX0043, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0044 STRING 接收终端 SMS 文本报警号码
            register(0x0044, B8103::getX0044, B8103::setX0044, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0045 DWORD 终端电话接听策略，0：自动接听；1：ACC ON 时自动接听，OFF 时手动接听
            register(0x0045, B8103::getX0045, B8103::setX0045, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0046 DWORD 每次最长通话时间，单位为秒（s），0 为不允许通话，0xFFFFFFF 为不限制
            register(0x0046, B8103::getX0046, B8103::setX0046, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0047 DWORD 当月最长通话时间，单位为秒（s），0 为不允许通话，0xFFFFFFF 为不限制
            register(0x0047, B8103::getX0047, B8103::setX0047, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0048 STRING 监听电话号码
            register(0x0048, B8103::getX0048, B8103::setX0048, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0049 STRING 监管平台特权短信号码
            register(0x0049, B8103::getX0049, B8103::setX0049, ver -> Codec::writeString, ver -> Codec::readString);

            // 0x0050 DWORD 报警屏蔽字，与位置信息汇报消息中的报警标志相对应，相应位为 1 则相应报警被屏蔽
            register(0x0050, B8103::getX0050, B8103::setX0050, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0051 DWORD 报警发送文本 SMS开关，与位置信息汇报消息中的报警标志相对应，相应位为 1 则相应报警时发送文本 SMS
            register(0x0051, B8103::getX0051, B8103::setX0051, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0052 DWORD 报警拍摄开关，与位置信息汇报消息中的报警标志相对应，相应位为 1 则相应报警时摄像头拍摄
            register(0x0052, B8103::getX0052, B8103::setX0052, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0053 DWORD 报警拍摄存储标志，与位置信息汇报消息中的报警标志相对应，相应位为 1 则对相应报警时拍的照片进行存储，否则实时上传
            register(0x0053, B8103::getX0053, B8103::setX0053, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0054 DWORD 关键标志，与位置信息汇报消息中的报警标志相对应，相应位为 1 则对相应报警为关键报警
            register(0x0054, B8103::getX0054, B8103::setX0054, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0055 DWORD 最高速度，单位为千米每小时（km/h）
            register(0x0055, B8103::getX0055, B8103::setX0055, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0056 DWORD 超速持续时间，单位为秒（s）
            register(0x0056, B8103::getX0056, B8103::setX0056, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0057 DWORD 连续驾驶时间门限，单位为秒（s）
            register(0x0057, B8103::getX0057, B8103::setX0057, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0058 DWORD 当天累计驾驶时间门限，单位为秒（s）
            register(0x0058, B8103::getX0058, B8103::setX0058, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0059 DWORD 最小休息时间，单位为秒（s）
            register(0x0059, B8103::getX0059, B8103::setX0059, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x005A DWORD 最长停车时间，单位为秒（s）
            register(0x005A, B8103::getX005A, B8103::setX005A, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);

            // 0x005B WORD 超速预警差值，单位为 1/10千米每小时（1/10km/h）
            register(0x005B, B8103::getX005B, B8103::setX005B, ver -> Codec::writeWord, ver -> Codec::readWord);
            // 0x005C WORD 疲劳驾驶预警差值，单位为秒（s），值大于 0
            register(0x005C, B8103::getX005C, B8103::setX005C, ver -> Codec::writeWord, ver -> Codec::readWord);
            // 0x005D WORD 碰撞报警参数设置，b7-b0为 碰撞时间，单位为毫秒（ms）；b15-b8为碰撞加速度，单位为 0.1g；设置范围为 0~79，默认为 10
            register(0x005D, B8103::getX005D, B8103::setX005D, ver -> Codec::writeWord, ver -> Codec::readWord);
            // 0x005E WORD 侧翻报警参数设置，侧翻角度，单位 1 度，默认为 30 度
            register(0x005E, B8103::getX005E, B8103::setX005E, ver -> Codec::writeWord, ver -> Codec::readWord);

            // 0x0064 DWORD 定时拍照控制，参数项格式和定义见表 14
            register(0x0064, B8103::getX0064, B8103::setX0064, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0065 DWORD 定距拍照控制，参数项格式和定义见表 15
            register(0x0065, B8103::getX0065, B8103::setX0065, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);

            // 0×0070 DWORD 图像/视频质量，设置范围为 1～10，1 表示最优质量
            register(0x0070, B8103::getX0070, B8103::setX0070, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0071 DWORD 亮度，设置范围为 0~255
            register(0x0071, B8103::getX0071, B8103::setX0071, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0072 DWORD 对比度，设置范围为 0～127
            register(0x0072, B8103::getX0072, B8103::setX0072, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0073 DWORD 饱和度，设置范围为 0~127
            register(0x0073, B8103::getX0073, B8103::setX0073, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0074 DWORD 色度，设置范围为 0~255
            register(0x0074, B8103::getX0074, B8103::setX0074, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);

            // 0x0080 DWORD 车辆里程表读数，单位：1/10km
            register(0x0080, B8103::getX0080, B8103::setX0080, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0081 WORD 车辆所在的省域 ID
            register(0x0081, B8103::getX0081, B8103::setX0081, ver -> Codec::writeWord, ver -> Codec::readWord);
            // 0x0082 WORD 车辆所在的市域 ID
            register(0x0082, B8103::getX0082, B8103::setX0082, ver -> Codec::writeWord, ver -> Codec::readWord);
            // 0x0083 STRING 公安交通管理部门颁发的机动车号牌
            register(0x0083, B8103::getX0083, B8103::setX0083, ver -> Codec::writeString, ver -> Codec::readString);
            // 0x0084 BYTE 车牌颜色，0.未上车牌 1.蓝色 2.黄色 3.黑色 4.白色 5.绿色 9.其他
            register(0x0084, B8103::getX0084, B8103::setX0084, ver -> Codec::writeByte, ver -> Codec::readByte);
            ...
            register(0x0090, B8103::getX0090, B8103::setX0090, ver -> Codec::writeByte, ver -> Codec::readByte);
            // 0x0091 BYTE GNSS 波特率，0x00：4800；0x01：9600；0x02：19200；0x03：38400；0x04：57600；05：15200
            register(0x0091, B8103::getX0091, B8103::setX0091, ver -> Codec::writeByte, ver -> Codec::readByte);
            // 0x0092 BYTE GNSS 模块详细定位数据输出频率，0x00：500ms；0x01：1000ms（默认值）；0x02：2000ms；0x03：3000ms；Ox04：4000ms
            register(0x0092, B8103::getX0092, B8103::setX0092, ver -> Codec::writeByte, ver -> Codec::readByte);
            // 0x0093 DWORD GNSS 模块详细定位数据采集频率，单位为秒（s），默认为 1
            register(0x0093, B8103::getX0093, B8103::setX0093, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            ...
            register(0x0094, B8103::getX0094, B8103::setX0094, ver -> Codec::writeByte, ver -> Codec::readByte);
            ...
            register(0x0095, B8103::getX0095, B8103::setX0095, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);

            // 0x0100 DWORD CAN 总线通道 1 采集时间间隔，单位为毫秒（ms），0 表示不采集
            register(0x0100, B8103::getX0100, B8103::setX0100, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0×0101 WORD CAN 总线通道 1 上传时间间隔，单位为秒（s），0 表示不上传
            register(0x0101, B8103::getX0101, B8103::setX0101, ver -> Codec::writeWord, ver -> Codec::readWord);
            // 0x0102 DWORD CAN 总线通道 2 采集时间间隔，单位为毫秒（ms），0 表示不采集
            register(0x0102, B8103::getX0102, B8103::setX0102, ver -> Codec::writeDoubleWord, ver -> Codec::readDoubleWord);
            // 0x0103 WORD CAN 总线通道 2 上传时间间隔，单位为秒（s），0 表示不上传
            register(0x0103, B8103::getX0103, B8103::setX0103, ver -> Codec::writeWord, ver -> Codec::readWord);
        ...
        private static <V> void register(long id, Function<B8103, V> getter, BiConsumer<B8103, V> setter,
        ...
        private static <V extends Codec> void register(long id,
                                                       Function<B8103, V> getter, BiConsumer<B8103, V> setter,
