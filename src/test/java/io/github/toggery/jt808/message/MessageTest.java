...
class MessageTest {
    ...
    static void codecMany(String name, Map<Integer, MessageMetadata> messageMetadataMap, Codec[] bodies) {
        ...
        System.out.println();
        System.out.println();
        final Map<Integer, Codec> bodyMap = Arrays.stream(bodies)
        ...
        for (final MessageMetadata metadata : metadataCollection) {
            ...
            final Class<?> bodyClass = metadata.getBodyClass();
            System.out.printf("%d/%d: %s, %s"
                    , ++index, metadataCollection.size(), metadata.getName()
                    , bodyClass == null ? "无消息体" : bodyClass.getSimpleName()
            );
            System.out.println();
            final Codec codec = bodyMap.get(metadata.getId());
            assertTrue((bodyClass == null && codec == null) || (bodyClass != null && codec != null),
                    "消息体类型与其实例必须同时为 null 或非 null");
            final Message<?> msg = Message.of(metadata.getId(), codec);
            codecOne(msg, buffs, messageMetadataMap, attributeMap);
            System.out.println();
        }
    }
...
//            msg.setVersion(1);
        ...
        try {
            Message.encode(msg, UnpooledByteBufAllocator.DEFAULT::buffer, buffs::add, attributeMap);
    ...
    static B0001 b0001() {
        ...
        b.setReplySn(1);
        b.setReplyId(2);
        b.setResult(B0001.RESULT_WRONG);
        return b;
    }
    static B0005 b0005() {
    ...
    static B0200_11 b0200_11() {
        final B0200_11 b = new B0200_11();
        b.setType(255);
        b.setId(2L);

        return b;
    }
    static B0200_12 b0200_12() {
        final B0200_12 b = new B0200_12();
        b.setType(255);
        b.setId(1L);
        b.setDirection(2);
    ...
    static B0200_13 b0200_13() {
        final B0200_13 b = new B0200_13();
        b.setId(1L);
        b.setDuration(2);
        b.setResult(3);
    ...
    static B0702 b0702() {
        ...
        b.setResult(B0702.RESULT_SUCCESSFUL);
        b.setName("驾驶员姓名");
    ...
    static B8602.Region b8602_Region(long id) {
        ...
        b.setId(id);
        b.setProps(3);
        b.setLatitudeTopLeft(3L);
        b.setLongitudeTopLeft(4L);
        b.setLatitudeBottomRight(5L);
        b.setLongitudeBottomRight(6L);
        b.setStartTime("220616123900");
        b.setEndTime("220616123959");
        b.setMaxSpeed(7);
        b.setDuration(8);
        b.setNightMaxSpeed(9);
        b.setName("名称");
